      ...
      <aside className={cx('menuMobile', { hidden: !ui.menuShown })}>
        <section>
          ...
          <ul>
            ...
            <li onClick={() => ui.toggleMenu()}><NavLink to='/reviews'><i className='fa fa-address-book-o' aria-hidden='true' /> - Reviews</NavLink></li>
      ...
      <aside className='menuDesktop'>
        <section>
          <ul>
            ...
            <li>|</li>
            <li><NavLink to='/reviews'><i className='fa fa-address-book-o' aria-hidden='true' /> - Reviews</NavLink></li>
            {/* <li>|</li> */}
